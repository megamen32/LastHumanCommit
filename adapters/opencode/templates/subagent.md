...
- Start initial Worker research through a fresh-agent boundary. Resume the same
  Worker for its selected implementation lane when supported; otherwise pass
  the compact Research section to a fresh Worker.
