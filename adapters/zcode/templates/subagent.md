...
- If ZCode exposes a live child-message channel (`send_message`), use it for
  every question, correction, or status request; do not replace the active
  child or use the task file as chat.
