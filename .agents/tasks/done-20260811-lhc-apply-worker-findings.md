...
Verification passed: `python3 tests/validate.py`, `sh tests/test_task_states.sh`,
`sh tests/test_task_resume_snapshots.sh`, and `cmp -s AGENTS.md CLAUDE.md`.
The exact current result is maintained at
