# /askhuman — deliver something important to the human

Usage: `/askhuman <what>` — a needed decision, a hard blocker, a
timing/status answer, or long-cycle completion. Sent as one compact message
through the already-connected AskHuman/notify MCP (Telegram). No new
infrastructure.
